...
if ($MATCODE=='null') {
	#No se ha indicado asignatura
	echo "<img src='apps/AD.png' height='42' width='42'>&nbsp;<img src='apps/NO.png' height='42' width='42'><br>No has indicado asignatura!";
}
else
{
		if ($Materia==$MATCODE) {
		...
		if ($Parametro=='A') {
			#Asignatura activa, comprobación de puntajes
		...
		{
			if ($Parametro=='C') {
				#Asignatura cancelada, detener operaciones
