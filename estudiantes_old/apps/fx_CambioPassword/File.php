...
<script type='text/javascript' src='jquery.form.js'></script>
    <!-- Script para submit -->
    	...
    	if(FormUpdatePass.PASSSOURCE.value.length==0) {
            FormUpdatePass.PASSSOURCE.focus();
            alert('Por favor indica tu contraseña actual');
            return false;
        }
...
echo "
        ...
        <form id='FormUpdatePass' name='FormUpdatePass' action='apps/fx_CambioPassword/UpdatePassword.php' method='POST' onsubmit='return ValidarCampos(this);'>

        <p><b>Contraseña actual:</b></p>
            <p><input type='password' name='PASSSOURCE' autocomplete='off' onkeypress='capLock(event)'><br></p><div id='caplock' style='visibility:hidden'><p style='color:red;'><b>Tienes activadas las mayúsculas</b></p></div>
