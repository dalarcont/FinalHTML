...
if (empty($UsuarioDatos)) {
    session_unset();
    session_destroy();
    echo "<script language='javascript'>function unLoginGotoLogin() {  window.location = './'; } setTimeout('unLoginGotoLogin()', 0000); alert('No se ha identificado correctamente...'); </script>";
